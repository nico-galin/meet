...
const SearchHousing = ({ }: Props) => {
  ...
  return (
    <VStack alignItems="center" paddingTop="30vh">
      <ProductHeader company='apple' product='Housing'/>
      <StackDivider height="5px" />
      <SearchBar onSubmit={onSubmit} onFocus={() => window.scrollBy(0, 1000)} onChange={() => {}} filters={housing_options["apple"]} placeholder="Search Meetups..."/>
